...
open_db(struct server_config *config, const char *filename)
{
    ...
    if (is_relay) {
        ovsdb_relay_add_db(db->db, relay_remotes, update_schema, config, *config->relay_leader_only_mode);
    }
    return NULL;
}
              ...
              bool *active, bool *relay_leader_only_mode)
{
    ...
    static const struct option long_options[] = {
        ...
        {"relay-leader-only-mode", no_argument, NULL, OPT_RELAY_LEADER_ONLY_MODE},
        {NULL, 0, NULL, 0},
    };
