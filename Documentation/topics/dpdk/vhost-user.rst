...
.. _`docs`: https://gitlab.com/qemu-project/qemu/-/blob/master/docs/devel/migration/postcopy.rst?ref_type=heads
...
.. _QEMU documentation: https://gitlab.com/qemu-project/qemu/-/blob/master/docs/system/devices/vhost-user.rst
