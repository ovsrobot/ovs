...
class KVParser(object):
    ...
    def parse(self):
        ...
        while kpos < len(self._string) and self._string[kpos] != "\n":
            ...
            split_parts = delim_pattern.split(self._string[kpos:], 1)
            ...
            if len(split_parts) == 3:
                # If not at the end of the string, re.split() should return
                # 3 strings: [keyword, delimiter, rest].
                delimiter = split_parts[1]
                rest = split_parts[2]

            # Extract the value from the rest of the string.
            value_str = ""
