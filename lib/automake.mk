...
noinst_LTLIBRARIES += lib/libovsutil.la

lib_libovsutil_la_SOURCES = \
	lib/aes128.c \
	lib/aes128.h \
	lib/async-append.h \
	lib/backtrace.c \
...
CLEANFILES += $(nodist_lib_libovsutil_la_SOURCES)

lib_LTLIBRARIES += lib/libopenvswitchutils.la

lib_libopenvswitchutils_la_SOURCES =
lib_libopenvswitchutils_la_LIBADD = lib/libovsutil.la $(SSL_LIBS) $(CAPNG_LDADD)
...
lib_libopenvswitch_la_LIBADD = lib/libovsutil.la $(SSL_LIBS) $(CAPNG_LDADD)
...
if HAVE_POSIX_AIO
lib_libovsutil_la_SOURCES += lib/async-append-aio.c
else
lib_libovsutil_la_SOURCES += lib/async-append-null.c
endif
...
if HAVE_OPENSSL
lib_libovsutil_la_SOURCES += lib/stream-ssl.c lib/dhparams.c
...
lib_libovsutil_la_SOURCES += lib/stream-nossl.c
endif

lib_libovsutil_la_SOURCES += lib/dns-resolve.h
if HAVE_UNBOUND
lib_libovsutil_la_SOURCES += lib/dns-resolve.c
else
lib_libovsutil_la_SOURCES += lib/dns-resolve-stub.c
endif
