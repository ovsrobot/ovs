...
int netdev_offload_dpdk_flow_flush(struct dpif_offload_rte_flow *,
                                   struct netdev *);
...
int netdev_offload_dpdk_hw_miss_packet_recover(struct dpif_offload_rte_flow *,
                                               struct netdev *,
                                               struct dp_packet *);
int netdev_offload_dpdk_flow_put(struct dpif_offload_rte_flow *,
