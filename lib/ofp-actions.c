                     ...
                     struct mf_subfield *src_out, uint32_t *imm_out)
{
    if (src) {
        ...
        if (src_out->n_bits != 32) {
            VLOG_WARN_RL(&rl, "field associated to sample observation id is "
        ...
        if (!strcmp(key, "probability")) {
            ...
            if (error) {
                ...
                if (os->obs_domain_src.n_bits != 32) {
                    error = xasprintf("invalid length of obs_domain_id field "
                                      "(%d). Must be 32",
            ...
            if (error) {
                ...
                if (os->obs_point_src.n_bits != 32) {
                    error = xasprintf("invalid length of obs_point_id field "
                                      "(%d). Must be 32",
