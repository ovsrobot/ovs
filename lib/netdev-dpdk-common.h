...
extern const struct rte_eth_conf dpdk_default_eth_conf;
...
struct netdev_dpdk_common {
    ...
    PADDED_MEMBERS_CACHELINE_MARKER(CACHE_LINE_SIZE, cacheline1,
        struct ovs_mutex mutex OVS_ACQ_AFTER(dpdk_common_mutex);
...
netdev_dpdk_rxq_cast(const struct netdev_rxq *rxq)
{
