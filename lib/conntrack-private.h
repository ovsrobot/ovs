...
extern alg_helper alg_helpers[CT_ALG_CTL_MAX];
 ...
 *
 * Registration is not thread-safe and must happen before any connection is
 * processed (i.e. during single-threaded module initialisation, under
 * ovsthread_once).
 */
