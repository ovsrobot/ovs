...
#define RCULIST_GET_SAFE_MACRO(_1, _2, _3, _4, NAME, ...) NAME
#define RCULIST_FOR_EACH_SAFE_PROTECTED(...)                                  \
    RCULIST_GET_SAFE_MACRO(__VA_ARGS__,                                       \
                   RCULIST_FOR_EACH_SAFE_LONG_PROTECTED,                      \
                   RCULIST_FOR_EACH_SAFE_SHORT_PROTECTED)(__VA_ARGS__)
