...
unsigned int reconnect_default_min_backoff(void) {
    ...
    if (default_min_backoff == 0) {
        ...
        if (default_min_backoff < RECONNECT_MIN_MIN_BACKOFF) {
...
unsigned int reconnect_default_max_backoff(void) {
    ...
    if (default_max_backoff == 0) {
        ...
        if (default_max_backoff < RECONNECT_MIN_MAX_BACKOFF) {
            default_max_backoff = RECONNECT_DEFAULT_MAX_BACKOFF;
        }
    }
...
unsigned int reconnect_default_probe_interval(void) {
    ...
    if (default_probe_interval == 0) {
        ...
        if (default_probe_interval < RECONNECT_MIN_PROBE_INTERVAL) {
            default_probe_interval = RECONNECT_DEFAULT_PROBE_INTERVAL;
        }
    }
